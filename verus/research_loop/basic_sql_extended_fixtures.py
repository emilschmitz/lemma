...
BASIC_SQL_EXTENDED_FIXTURES: dict[str, BasicSqlExtendedFixture] = {
    ...
    "cross_join": BasicSqlExtendedFixture(
        ...
        table_order=("a", "b"),
        default_tbls={"a": "verus/research_loop/testdata/basic_cross_join_a.tbl", "b": "verus/research_loop/testdata/basic_cross_join_b.tbl"},
        is_join=True,
    ),
    "full_join_sum": BasicSqlExtendedFixture(
        ...
        table_order=("a", "b"),
        default_tbls={"a": "verus/research_loop/testdata/basic_full_join_a.tbl", "b": "verus/research_loop/testdata/basic_full_join_b.tbl"},
        is_join=True,
    ),
    "semi_join": BasicSqlExtendedFixture(
        ...
        table_order=("a", "b"),
        default_tbls={"a": "verus/research_loop/testdata/basic_semi_join_a.tbl", "b": "verus/research_loop/testdata/basic_semi_join_b.tbl"},
        is_join=True,
    ),
    "anti_join": BasicSqlExtendedFixture(
        ...
        table_order=("a", "b"),
        default_tbls={"a": "verus/research_loop/testdata/basic_anti_join_a.tbl", "b": "verus/research_loop/testdata/basic_anti_join_b.tbl"},
        is_join=True,
    ),
    "nway_join_sum": BasicSqlExtendedFixture(
        ...
        table_order=("a", "b", "c"),
        default_tbls={
            "a": "verus/research_loop/testdata/basic_nway_join_a.tbl",
            "b": "verus/research_loop/testdata/basic_nway_join_b.tbl",
            "c": "verus/research_loop/testdata/basic_nway_join_c.tbl",
        },
        is_join=True,
        is_nway_join=True,
    ),
