...
from research_loop.dafny_legacy.pipeline_columnar import DEFAULT_TBL, dafny_translate_cmd, sync_rust_src
...
def optimize_rust_file(file_path, *, allow_fast_native_agg: bool = True):
    from research_loop.dafny_legacy.postprocessor import postprocess
...
"""
    ...
    from research_loop.dafny_legacy.admit_runquery import admit_runquery
    ...
    with demo_live_step("⚙", "Post-process Rust", pass_fail=True) as post_step:
        ...
        try:
            from research_loop.dafny_legacy.postprocessor import inject_hot_loop_main, postprocess
            postprocess(
                rust_src,
                tbl_path,
                args.dataset_size,
