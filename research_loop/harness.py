...
def run_ssb_pipeline(
    ...
    *,
    ...
    if _legacy_unproved_enabled():
        from research_loop.harness_legacy import run_ssb_pipeline_legacy
...
def run_tpch_pipeline(
    ...
    *,
    ...
    if _legacy_unproved_enabled():
        from research_loop.harness_legacy import run_tpch_pipeline_legacy
...
def run_basic_sql_pipeline(
    ...
    *,
    ...
    rs_path = os.path.join(GENERATED, f"basic_{feature_key}.rs")
    default_tbl = f"research_loop/testdata/basic_{feature_key}.tbl"
    write_unified_program(
        rs_path=rs_path,
        sql=fx.sql,
        schema=fx.schema,
