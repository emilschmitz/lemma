...
fn main() {
    ...
    let pin_cpp = manifest_dir.join("../../db_extension_paths/src/lemma_pin.cpp");
    let stream_cpp = manifest_dir.join("../../db_extension_paths/src/lemma_stream.cpp");
    let pin_inc = manifest_dir.join("../../db_extension_paths/src");
