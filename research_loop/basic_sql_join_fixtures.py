...
BASIC_SQL_JOIN_FIXTURES: dict[str, BasicSqlJoinFixture] = {
    "inner_join_sum": BasicSqlJoinFixture(
        ...
        default_tbls={
            "orders": "research_loop/testdata/basic_inner_join_orders.tbl",
            "customers": "research_loop/testdata/basic_inner_join_customers.tbl",
        },
        bench_limit=100_000,
    ...
    "left_join_sum": BasicSqlJoinFixture(
        ...
        default_tbls={
            "orders": "research_loop/testdata/basic_left_join_orders.tbl",
            "customers": "research_loop/testdata/basic_left_join_customers.tbl",
        },
        bench_limit=100_000,
        hot_path=_SYNTH_JOIN_HOT,
        bench_exec=(
