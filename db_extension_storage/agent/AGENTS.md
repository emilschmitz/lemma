...
You optimize **one path only**: `db_extension_storage/` (below Chunk API — **DataTable** / row-group storage scan).
...
See `research_loop/agents/AGENTS.md`. Primary gaps on `SESSION_HOT_US` are **agent/kernel**.
