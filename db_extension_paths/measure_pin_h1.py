...
HOLDOUT = ROOT / "research_loop/holdout"
...
PIN_SMOKE = ROOT / "db_extension_paths/rust_bridge/target/release/lemma_pin_h1_smoke"
CHECK_MEM = ROOT / "db_extension_paths/check_mem.sh"
OUT = ROOT / "db_extension_paths/pin_h1_measure.json"
