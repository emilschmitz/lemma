...
Competitors (one process each; binary prints median of 5 timed queries):
  - lemma_chunk_e2e    (db_extension_runtime — Chunk API, Lemma filter+agg)
  - lemma_lease_e2e    (db_extension_lease — pin/lease + zone maps)
  - lemma_storage_e2e  (db_extension_storage — DataTable storage scan)
...
OUT = ROOT / "db_extension_paths/e2e_paths_h1.json"

BINS: dict[str, Path] = {
    "lemma_chunk_e2e": ROOT
    / "db_extension_runtime/rust_bridge/target/release/lemma_runtime_h1_e2e",
    "lemma_lease_e2e": ROOT
    / "db_extension_lease/rust_bridge/target/release/lemma_lease_h1_e2e",
    "lemma_storage_e2e": ROOT
    / "db_extension_storage/rust_bridge/target/release/lemma_storage_h1_e2e",
    "duckdb_sql_e2e": ROOT
    / "db_extension_paths/rust_bridge/target/release/duckdb_sql_h1_e2e",
}

COPY_BIN = ROOT / "db_extension_paths/rust_bridge/target/release/lemma_copy_h1_smoke"
    ...
    payload = {
        ...
        "paths": {
            "lemma_chunk_e2e": {
                ...
                "folder": "db_extension_runtime",
                "agent": "db_extension_runtime/agent/AGENTS.md",
            },
            "lemma_lease_e2e": {
                "clear_name": "lemma_lease",
                "folder": "db_extension_lease",
                "agent": "db_extension_lease/agent/AGENTS.md",
            },
            "lemma_storage_e2e": {
                "clear_name": "lemma_storage",
                "folder": "db_extension_storage",
                "agent": "db_extension_storage/agent/AGENTS.md",
            },
            "duckdb_sql_e2e": {
                "clear_name": "duckdb_sql",
                "folder": "db_extension_paths/rust_bridge",
                "agent": None,
            },
            "lemma_copy_e2e": {
                "clear_name": "lemma_copy",
                "folder": "db_extension_paths",
                "agent": "db_extension_paths/agent/AGENTS.md",
                "optional": True,
            },
        },
        "rows": rows,
